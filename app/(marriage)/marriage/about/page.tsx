...
export const metadata = {
  ...
  description: "Marriage counseling and relationship coaching from Drs. Jomo and Charmaine Cousins. 24+ years married, 1,000+ couples counseled. In-person in Riverview, FL or virtual sessions available.",
  alternates: {
