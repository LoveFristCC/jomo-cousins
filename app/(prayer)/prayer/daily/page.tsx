...
import { prayerOfTheDayQuery, recentPrayersQuery } from "@/sanity/lib/queries";
...
export const metadata: Metadata = {
  title: "Daily Prayer Series | Jomo Cousins",
  description: "Join Jomo Cousins for daily prayer. Start each morning with spiritual encouragement, biblical guidance, and peace. Subscribe to pray with Jomo every day.",
  alternates: {
    canonical: "https://www.jomocousins.com/prayer/daily",
  },
  openGraph: {
    title: "Daily Prayer with Jomo Cousins",
...
export default async function DailyPrayerPage() {
  const [todaysPrayer, recentDailyPrayers] = await Promise.all([
    sanityFetch({ query: prayerOfTheDayQuery }),
    sanityFetch({ query: recentPrayersQuery, params: { limit: 12 } }),
  ]);
  ...
  // Add VideoObject for today's prayer
  if (todaysPrayer) {
    (structuredData["@graph"] as any[]).push({
      "@type": "VideoObject",
      name: todaysPrayer.title,
      description: todaysPrayer.excerpt,
      thumbnailUrl: todaysPrayer.featuredImage
        ? urlForImage(todaysPrayer.featuredImage)?.url()
        : undefined,
      uploadDate: todaysPrayer.publishedAt,
      duration: todaysPrayer.duration,
      contentUrl: todaysPrayer.youtubeUrl,
      embedUrl: `https://www.youtube.com/embed/${todaysPrayer.youtubeVideoId}`,
    });
  }
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-5">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="mb-6 text-4xl font-bold md:text-5xl lg:text-6xl">
              Daily Prayer with Jomo
            </h1>
            <p className="text-xl leading-relaxed text-gray-300 md:text-2xl">
              Start each day grounded in prayer. Join Jomo for daily spiritual
              encouragement.
            </p>
          </div>
        </div>
            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="overflow-hidden rounded-2xl bg-white shadow-2xl">
                ...
                <div className="relative aspect-video w-full">
                  <iframe
                    src={`https://www.youtube.com/embed/${todaysPrayer.youtubeVideoId}`}
                    title={todaysPrayer.title}
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    className="absolute inset-0 h-full w-full"
                    aria-label={`Today's prayer video: ${todaysPrayer.title}`}
                  />
                </div>
                ...
                <div className="p-8 md:p-12">
                  ...
                  {todaysPrayer.excerpt && (
                    <p className="mb-6 text-lg leading-relaxed text-gray-600">
                      {todaysPrayer.excerpt}
                    </p>
                  )}
                  <Link
                    href={`/prayer/${todaysPrayer.slug}`}
                    className="inline-block rounded-lg bg-[#e31e24] px-6 py-3 font-bold text-white transition-colors hover:bg-[#c41a1f]"
                  >
                    View Full Prayer →
                  </Link>
                </div>
            ...
            <div className="grid items-center gap-12 md:grid-cols-2">
              ...
              <div>
                <h2 className="mb-6 text-3xl font-bold text-[#3d3d3d] md:text-4xl">
                  Pray with Jomo Every Morning
                </h2>
                <div className="space-y-4 text-gray-700">
                  <p>
                    Every morning, I record a prayer to help you start your day
                    with God. These aren't just prayers - they're personal
                    moments where I'm inviting you to join me in conversation
                    with our Father.
                  </p>
                  <p>
                    Whether you're facing challenges, seeking guidance, or
                    simply wanting to grow closer to God, I believe that
                    starting your day in prayer changes everything.
                  </p>
                  <p className="font-semibold">
                    Join me each morning. Let's build a habit of prayer
                    together.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-5">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="mb-6 text-2xl font-bold text-[#3d3d3d] md:text-3xl">
              Never Miss a Daily Prayer
            </h2>
            <p className="mb-8 text-lg text-gray-600">
              Follow Jomo for daily prayer updates and spiritual encouragement
            </p>

            <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-center">
              {/* YouTube Subscribe */}
              <a
                href="https://www.youtube.com/@pastorjomocousins?sub_confirmation=1"
                target="_blank"
      ...
      {/* Bottom CTA */}
      <section className="bg-gradient-to-b from-[#3d3d3d] to-[#2d2d2d] py-16 text-white">
        <div className="container mx-auto px-5">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-xl text-gray-300">
              Join thousands who begin each morning praying with Jomo
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-lg bg-red-600 px-8 py-4 font-bold text-white transition-colors hover:bg-red-700"
              >
