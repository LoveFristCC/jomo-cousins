...
export default function Footer() {
  return (<footer className="bg-[#303030] py-12 text-white">
    <div className="container mx-auto px-5">
      <div className="grid gap-8 md:grid-cols-3">
        {/* About */ }
        <div>
          <h3 className="mb-4 text-xl font-bold">Jomo & Charmaine</h3>
          <p className="text-sm text-gray-400">
            Licensed marriage and family therapists dedicated to helping couples
      ...
      <div className="mt-8 border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
        <p>&copy; 2025-{ new Date().getFullYear() } Jomo & Charmaine. All rights reserved.</p>
      </div>
    </div>
  </footer>)
}