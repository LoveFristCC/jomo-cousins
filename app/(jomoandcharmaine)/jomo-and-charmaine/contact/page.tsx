    ...
    <div className="bg-white">
      ...
      <section className="relative h-[400px] md:h-[500px]">
        ...
        <Image
          ...
          alt="We Would Love to Hear From You"
          fill
        ...
        <div className="container mx-auto px-5">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-relaxed text-gray-600">
              Please fill out the form below and we will be in touch with you to schedule an appointment.
            </p>
            ...
            <div className="flex justify-center gap-6">
              <a
                ...
                className="text-gray-400 transition-colors hover:text-[#ea8125]"
                aria-label="YouTube"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 transition-colors hover:text-[#0E6BB7]"
                aria-label="Facebook"
              >
                <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 transition-colors hover:text-[#303030]"
                aria-label="Twitter"
              >
                <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
