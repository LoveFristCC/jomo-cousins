        ...
        <div className="container mx-auto px-5">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden items-center gap-1 lg:flex">
              ...
              <Link
                href="/contact"
                className="mr-6 rounded-full bg-[#e31e24] px-7 py-2.5 text-xs font-black uppercase tracking-widest shadow-lg shadow-red-900/20 transition-all hover:scale-105 hover:bg-[#c41a1f] active:scale-95"
              >
                Book Now
              </Link>
              ...
              <a
                ...
                className="text-xs font-bold uppercase tracking-widest text-gray-300 transition-colors hover:text-white"
              >
                Login
              </a>
            </div>
      ...
      >
        ...
        <div className="mt-12 flex flex-col gap-8">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={ () => setMobileMenuOpen(false) }
            className="text-center text-sm font-bold uppercase tracking-widest text-gray-300"
          >
            Member Login
          </a>
        </div>
