  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        {/* Content */ }
        <div className="relative container mx-auto px-5 py-32 md:py-40">
        ...
        <div className="relative container mx-auto px-5">
          <div className="mx-auto max-w-6xl">
            <h2 className="mb-4 text-center text-4xl font-bold text-[#2d2d2d] md:text-5xl">
              Trusted <span className="text-[#e31e24]">By</span>
            </h2>
            <p className="mb-16 text-center text-xl text-gray-600">
              Dr. Jomo Cousins has inspired audiences at organizations worldwide
            </p>
